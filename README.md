...
- `DISCORD_WEBHOOK_URL` - (Optional) Webhook for bot status notifications
- `NVIDIA_API_KEY` - (Optional) For AI features

**Security Alerts:** Bot automatically sends security alerts to `#security-log` channel in your server. Create this channel to receive spam/raid/nuke notifications.
